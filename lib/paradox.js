...
module.exports = class ParadoxConnector {
    ...
    Connect() {
        ...
        this._mqttClient.on("connect", () => {
            ...
            this._mqttClient.subscribe("paradox/interface/availability");
        });
    ...
    TranslateCommand(command) {
        ...
        if (command.indexOf("AL") === 0) {
            ...
            var currentState = "paradox/states/partitions/"+ name + "/current_state"
            var partitionData = {
                name: name,
                ...
                device: device,
                state_topic: currentState,
                command_topic: "paradox/control/partitions/" + name,
